...
**Связанные модули:**
*   [Monitor](Moderator-Monitor.md) — реал-тайм мониторинг активности
*   [Events](Moderator-Events.md) — управление событиями для отображения на витрине
*   [Users](Moderator-Users.md) — управление пользователями для статистики
