...
### Особенности
*   **Блокировка интерфейса**   **Inline Editing**: Редактирование названия тега происходит прямо в списке через `contenteditable`.
*   **Автосохранение**: При потере фокуса (`blur`) изменения автоматически отправляются на сервер.
*   **Удаление**: Реализовано через кнопку с подтверждением (модальное окно).
...
**Связанные модули:**
*   [Tags1](Moderator-Tags1.md) — управление специализированными тегами (категории)
*   [Users](Moderator-Users.md) — управление тегами пользователей
*   [Monitor](Moderator-Monitor.md) — статистика по популярным тегам

**Другие интерфейсы:**
*   [Manager-Tags](Manager-Tags.md) — управление тегами в панели менеджера
