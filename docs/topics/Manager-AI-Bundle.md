# 🤖 Менеджер: Отправка ИИ (AI Bundle)

**Код:** `frontend/club-manager/src/views/Bundle.svelte` (предположительно)  
**Роут:** `/bundle` (Layout: `Main`)

Модуль **AI Bundle** — инструмент для работы с ИИ-рекомендациями и историей отправок персонализированных предложений клиентам. Разделен на две функциональные части:
