...
**Связанные модули:**
*   [Dashboard](Moderator-Dashboard.md) — статистика и аналитика по опросам
*   [Users](Moderator-Users.md) — управление участниками опросов
*   [Events](Moderator-Events.md) — опросы в контексте событий

**Другие интерфейсы:**
*   [Manager-Polls](Manager-Polls.md) — расширенное управление опросами в панели менеджера
