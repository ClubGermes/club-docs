...
**Связанные модули:**
*   [Communities](Moderator-Communities.md) — управление сообществами-организаторами событий
*   [Dashboard](Moderator-Dashboard.md) — статистика и аналитика по событиям
*   [Users](Moderator-Users.md) — управление участниками событий

**Другие интерфейсы:**
*   [Manager-Events](Manager-Events.md) — расширенное управление событиями в панели менеджера
*   [Mobile-Events](Mobile-Events.md) — отображение событий в мобильном приложении
